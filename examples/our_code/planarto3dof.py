...
beluga.add_logger(file_level=logging.DEBUG, display_level=logging.INFO, filename='beluga_1.log')
...
for sol in sol_set:
    ...
    # continuation_steps_2a.add_step('bisection').num_cases(11) \
    ...
    beluga.add_logger(file_level=logging.DEBUG, display_level=logging.INFO, filename='beluga_2a.log')
    ...
    # continuation_steps_2b.add_step('bisection').num_cases(11) \
    #     .const('phi_f', -0.5*pi/180)
    ...
    beluga.add_logger(file_level=logging.DEBUG, display_level=logging.INFO, filename='beluga_2b.log')
...
ocp = None
bvp = None
save(out, ocp, bvp, filename='data_2.beluga')
